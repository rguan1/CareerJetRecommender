...
//    private Map<String, Set<String>> searchCriteria; 
     ...
     */
    public Search() {
//        searchCriteria = new HashMap<String, Set<String>>();
//        searchCriteria.put("location", null); 
//        searchCriteria.put("keywords", null); 
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        locationEntered.setText("Vietnam, Boston, ...");
        ...
        keywordsEntered.setText("President, Java, Google, ...");
    ...
    private void searchButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchButtonMouseClicked
        ...
        ArrayList<JobPost> searchResults = new ArrayList<JobPost>();     
        for (int i = 0; i < 5; i++) {
    ...
    private void makeTopMatchesScreen(ArrayList<JobPost> searchResults) {
        final JFrame topResults = new JFrame();
        ...
        Object[][] data = new Object[][] {
            {"1. " + searchResults.get(0).getTitle(), 
        ...
        table.add
        topResults.add(new JScrollPane(table)); 
